...
export class PublicTrackerAssignmentUpdateCommand implements ICommand {
    constructor(public readonly imei: string, public readonly updateDto: PublicTrackerAssignmentUpdateDto) { }
}

export class PublicTrackerAssignmentUpdateDto {
    @ApiProperty({
